...
"Honda","Lincoln","Hummer","Acura","Buick","BMW","Chevrolet","Cadillac","BMW","BMW","BMW","Pontiac","Suzuki","Mitsubishi","Jeep","Buick","Ford");
...
"1N6AA0CJ1D57470", "WAUEG98E76A780908", "WAUAF78E96A920706", "1FTEW1CW4AF371278", "1FTEW1CW4AF371278",  "JN1AZ4EH8DM531691", "WAUEKAFBXAN294295", 
"1N6AA0EDXFN868772", "WBADW3C59DJ422810");
                ...
                if (count($autod) == count($vins)){
                    echo 'Massiivid klapivad!';
                }else{
                    echo 'Massiivides arvud ei klapi <br>';
                    echo "autode arv<br>";
                    echo "VIN arv ";
                }

                echo "<h2>Sorteerimine</h2>";
                ...
                echo "Toyotasid on $toyotad <br>";
                echo "Audisid on $audid";
                echo "<h2>VIN väiksemad kui 17</h2>";
...
"璟雯","崇杉","俊誉","军卿","辰华","娅楠","志宸","欣妍","明美");
                ...
                sort($hiina);
                foreach($hiina as $hiin){
                    echo "$hiin <br>";
                }

                echo "<h2>Esimene ja viimane nimi</h2>";

                echo $esimene = $hiina[0];
                echo "<br>";
                echo end($hiina);
   ...
   ?>
                ...
                foreach($pildid as $pilt){
                    echo "<img src='img/$pilt' alt='$pilt'><br>";
                }
                ?>
            </div>
        </div>
